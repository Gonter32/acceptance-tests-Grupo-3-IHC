Escenario: Lista de Profesores
Dado que soy un estudiante registrado en SmartProfe
Cuando inicie sesión en mi cuenta 
Y vaya a la sección "Lista de Profesores"
Entonces debería ver una lista completa de todos los profesores de la universidad, Además, 
...
Escenario: Organización de Profesores
Dado que soy un estudiante registrado en SmartProfe
Cuando inicie sesión en mi cuenta 
Y vaya a la sección "Organización de Profesores"
Entonces los profesores deben estar organizados de manera clara y lógica por departamento y área de especialización.
